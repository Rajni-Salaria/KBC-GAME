# K.B.C Game:
print("Welcome to Game koun Bnega Crorepati")
...
print()
Game = [{
    'Question': 'ques1 Which of these is the name of a Zodiac sign as well as a National Award winning Hindi film actor?',
